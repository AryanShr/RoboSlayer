...
/*Adding and defining positions for bullets*/
...
/*To delete the bullets creates otherwise cause memory leak*/
...
/*Left spawn enemy bullets deletion*/
...
/*To generate all moving sprites*/
...
/*Key events: Pressed or released*/
...
/*Initialising our main charachter*/
...
/*To check for collision of two entities*/
...
int bulletdestroy = 0;
/*All movements and events done by player in this function*/
void doplayer()
{
	int pressed = 0;
...
/*Rendering the begining of game screen*/
void startscreen()
{
	...
	SDL_Rect rect = {600, 150, starttextureW, starttextureH};
...
/*Rendering the end games screen*/
void endscreen()
{
	SDL_Renderer *renderere = app.renderer;
	SDL_SetRenderDrawColor(renderere, 0, 0, 0, 255);
	...
	system("@cls||clear"); // To clear the terminal
	TTF_CloseFont(font);
	SDL_DestroyTexture(starttexture);
}
